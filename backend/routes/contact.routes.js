...
const { submitContact, getContacts, getContactById, replyToContact, updateContactStatus, getMessagesByEmail, clientReplyToMessage } = require('../controllers/contact.controller');
...
router.post('/:id/client-reply', clientReplyToMessage); // Public endpoint for client replies
